    ...
    if DATASOURCE_TYPE == "AzureCognitiveSearch":
        ...
        data_source = {
            ...
            "parameters": {
                ...
                "authentication": {"type": "APIKey", "key": PINECONE_API_KEY},
    ...
    if "vector" in query_type.lower() and DATASOURCE_TYPE != "AzureMLIndex":
        ...
        if AZURE_OPENAI_EMBEDDING_NAME:
            ...
            embeddingDependency = {
                ...
                "authentication": {"type": "APIKey", "key": AZURE_OPENAI_EMBEDDING_KEY},
            }
...
def prepare_model_args(request_body):
    ...
    if SHOULD_USE_DATA:
        model_args["extra_body"] = {"dataSources": [get_configured_data_source()]}
    ...
    if model_args_clean.get("extra_body"):
        ...
        for secret_param in secret_params:
            if model_args_clean["extra_body"]["dataSources"][0]["parameters"].get(
                secret_param
            ):
                model_args_clean["extra_body"]["dataSources"][0]["parameters"][
                    secret_param
                ] = "*****"
        authentication = model_args_clean["extra_body"]["dataSources"][0][
            "parameters"
        ].get("authentication", {})
        ...
        embeddingDependency = model_args_clean["extra_body"]["dataSources"][0][
            "parameters"
