...
1. `az webapp up --runtime PYTHON:3.11 --sku B1 --name wapp-aai-dev-sonacllm-01 --resource-group rg-aai-dev-sonacllm-01 --plan asp-wapp-aai-dev-sonacllm-01`
1. `az webapp config set --startup-file "python3 -m gunicorn app:app" --name wapp-aai-dev-sonacllm-01 --resource-group rg-aai-dev-sonacllm-01`
